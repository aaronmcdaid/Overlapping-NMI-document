...
This can also be understood with reference to \cref{figVenn}. The problem arises
when one cover is more complicated than the other, for example if it has many
more clusters than the other. This corresponds to a very large circle in \cref{figVenn}.
